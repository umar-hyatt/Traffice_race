...
public class RCC_EditorWindows : Editor {
	...
	#region Add Cameras
	[MenuItem("Tools/BoneCracker Games/Realistic Car Controller/Create/Cameras/Add FPS Camera To Vehicle", false, -50)]
	...
	[MenuItem("Tools/BoneCracker Games/Realistic Car Controller/Create/Cameras/Add FPS Camera To Vehicle", true)]
	...
	[MenuItem("Tools/BoneCracker Games/Realistic Car Controller/Create/Cameras/Add TPS Camera To Vehicle", false, -50)]
	public static void CreateWheelCamera(){
		...
		if(!Selection.activeGameObject.GetComponentInParent<RCC_CarControllerV3>()){
			...
			GameObject wheelCam = new GameObject("TPSCamera");
	...
	[MenuItem("Tools/BoneCracker Games/Realistic Car Controller/Create/Cameras/Add TPS Camera To Vehicle", true)]
